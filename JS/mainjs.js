	...
	photo.addEventListener("mouseover", profilePic);

	function profilePic(){
		photoID.innerHTML == 'Alter';
		if (photoID.innerHTML == 'Charles' ) {
			photoID.innerHTML = 'Alter'
			photo.src = 'IMAGES/kaigai-niki_sq.png'
		}

		else if (photoID != 'Charles' ){
			photoID.innerHTML = 'Charles'
			photo.src = "IMAGES/charles001_sq.png"
		}
	}
